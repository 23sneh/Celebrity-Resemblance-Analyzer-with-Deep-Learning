...
set_background('kit/images.jpg')


config = read_yaml("yaml/config.yaml")
params = read_yaml('yaml/params.yaml')
...
main_title = "<center><div><p class='highlight grey' style='font-size:47px'><span class='bold'>Check which celebrity you resemble with</span></span></div></center>"
...
if uploaded_image is not None:
    if save_upload_image(uploaded_image):
        ...
        with col2:
            st.markdown("Your look alike celelb face")
